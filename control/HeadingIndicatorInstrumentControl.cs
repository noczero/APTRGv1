...
namespace APTRGv1
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(APTRGv1.control.Resource1.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(APTRGv1.control.Resource1.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(APTRGv1.control.Resource1.HeadingIndicator_Aircraft);        
