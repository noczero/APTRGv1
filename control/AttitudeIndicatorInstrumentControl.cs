...
namespace APTRGv1
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(APTRGv1.control.Resource1.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(APTRGv1.control.Resource1.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(APTRGv1.control.Resource1.Maquette_Avion);
