...
namespace APTRGv1
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(APTRGv1.control.Resource1.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(APTRGv1.control.Resource1.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(APTRGv1.control.Resource1.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(APTRGv1.control.Resource1.Bandeau_Dérouleur);
