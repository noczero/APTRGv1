...
namespace APTRGv1
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(APTRGv1.control.Resource1.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(APTRGv1.control.Resource1.AirSpeedNeedle);
