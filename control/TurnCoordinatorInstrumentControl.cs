...
namespace APTRGv1
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(APTRGv1.control.Resource1.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(APTRGv1.control.Resource1.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(APTRGv1.control.Resource1.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(APTRGv1.control.Resource1.TurnCoordinatorMarks);
